...
pub fn summaries() -> Vec<SegmentSummary> {
    vec![
        ...
        SegmentSummary {
            ...
            description: "Keep sensitive relationships private without losing convenience — redact names, addresses, and notes before they ever sync to the cloud or a third-party device.",
        },
        SegmentSummary {
            href: "/ai/",
...
pub async fn it() -> HttpResponse {
    render_segment(SegmentCopy {
        ...
        hero_subhead: "Employees may try to install unvetted sync tools, no matter what policy you write. option63 gives them a convenient and safe-ish alternative: by stripping sensitive fields before data leaves managed devices, any tool they use — official or not — only ever sees a limited, low-risk subset.",
...
pub async fn personal() -> HttpResponse {
    render_segment(SegmentCopy {
        ...
        hero_subhead: "Cloud contacts expose who you know and what you're dealing with. option63 transforms your own vCards before they ever sync — initials instead of full names, relayed emails instead of real addresses, redacted notes.",
        problem_title: "What your cloud learns about you",
        problem_before: "Your personal contacts sync to the cloud and third-party devices in full: real names, personal email addresses, private notes about family, doctors, and sensitive relationships. A compromised account exposes all of it.",
