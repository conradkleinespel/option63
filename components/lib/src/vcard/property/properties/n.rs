...
use crate::vcard::property::NError::TooManyFields;
...
use crate::vcard::property::{parse_property_fields_and_values, run_full};
...
impl NProperty {
    pub fn parse(value: Vec<u8>, params: Vec<Param>, ctx: ParseContext) -> Result<Self, NError> {
        ...
        // - Honorific Prefixes
        // - Honorific Suffixes
        let fields = run_full(parse_property_fields_and_values(
            value.as_slice(),
            true,
            true,
            ctx.strict,
